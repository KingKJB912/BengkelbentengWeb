<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="url('/testimonials')" :active="request()->routeIs('testimonials')">
                        {{ __('Testimoni') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="url('/gallery')" :active="request()->routeIs('gallery')">
                {{ __('Galeri') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="url('/testimonials')" :active="request()->routeIs('testimonials')">
                {{ __('Testimoni') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="url('/booking')" :active="request()->routeIs('booking')">
                {{ __('Booking') }}
            </x-responsive-nav-link>
        </div>
